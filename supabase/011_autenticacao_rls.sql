...
-- ==========================================
-- Remove policies antigas e cria novas (estritamente por usuário)
-- IMPORTANTE: Antes de ativar estas policies, vincule TODOS os dados
-- existentes ao seu user_id rodando os UPDATEs da seção 2 acima.
